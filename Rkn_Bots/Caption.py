...
@Client.on_message(filters.private & filters.user(Star_light_10.ADMIN)  & filters.command(["rknusers"]))
...
@Client.on_message(filters.private & filters.user(Star_light_10.ADMIN) & filters.command(["broadcast"]))
...
@Client.on_message(filters.private & filters.user(Star_light_10.ADMIN) & filters.command("restart"))
...
async def start_cmd(bot, message):
    ...
    await message.reply_photo(photo=Star_light_10.RKN_PIC,
        ...
        reply_markup=types.InlineKeyboardMarkup([[
            types.InlineKeyboardButton('Main Channel', url='https://t.me/Star_Boy_96_vibes'),
            types.InlineKeyboardButton('Help Group', url='https://t.me/+YTq567GbiJY3M2Fl')
            ],[
            types.InlineKeyboardButton('🔥 Source Code 🔥', url='https://t.me/Star_Boy_96_vibes')
    ]]))
            ...
            if obj and hasattr(obj, "file_name"):
                ...
                try:
                    if cap_dets:
                        ...
                        replaced_caption = Star_light_10.DEF_CAP.format(file_name=file_name, caption=caption, language=extract_language(file_name), year=extract_year(file_name))
                        await message.edit(replaced_caption)
                except FloodWait as e:
